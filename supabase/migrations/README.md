...
| `0004_bao_dam_ho_so.sql` | ⬜ Chưa | **Cần chạy.** Dựng trigger sinh hồ sơ mà `0002` không có, bù hồ sơ cho hai tài khoản mới, chỉ định admin. Sửa email ở mục 4 trước khi chạy. |
